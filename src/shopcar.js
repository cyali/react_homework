    ...
    return (
      <div>
        <ul>
          {this.state.carts.map((item, i) => {
            return (
                <Lis item={item} key={item.id} add={this.add} reduce={this.reduce} checkStatus={this.checkStatus}/>
            )
          })}
        </ul>
        <hr/>
